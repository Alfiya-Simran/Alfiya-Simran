...
|--------|-------------|------------|
| 📊 **E-Commerce Sales & Profit Intelligence Dashboard** | End-to-end Business Intelligence project analyzing 9,900+ e-commerce transactions to uncover sales trends, customer behavior, regional performance, and profitability insights through interactive dashboards and SQL-driven business analysis. | Python · Pandas · MySQL · SQL · Power BI · Excel · Git |
| 👥 **HR Analytics Dashboard** *(In Progress)* | Building an interactive HR analytics solution to analyze employee attrition, workforce demographics, job satisfaction, and performance metrics to support strategic HR decision-making. | SQL · Power BI · DAX · Excel · Python |
| 🤖 **Customer Churn Prediction & Analytics** *(Planned)* | Developing an end-to-end analytics and machine learning solution to identify customer churn patterns, analyze retention drivers, and build predictive models for proactive business decisions. | Python · SQL · Pandas · Scikit-learn · Power BI |
...
- Completed an end-to-end E-Commerce Sales & Profit Intelligence Dashboard featuring ETL, SQL business analysis, KPI reporting, and interactive Power BI visualizations.
- Published the project with comprehensive documentation, GitHub repository, portfolio integration, and professional business insights.
- Currently building a portfolio of real-world analytics projects across HR, Finance, Customer Analytics, and Healthcare while preparing for Data Analyst and Data Science opportunities.
...
## 📫 Connect With Me  
[![LinkedIn](https://img.icons8.com/?size=100&id=13930&format=png&color=000000)](http://www.linkedin.com/in/alfiyasimran)
[![Portfolio](https://img.icons8.com/?size=50&id=AfM2kzPzTz6Q&format=png&color=000000)](https://portfolio-alfiyasimran.vercel.app)
[![Mail](https://img.icons8.com/?size=100&id=qyRpAggnV0zH&format=png&color=000000)](simranalfiya@gmail.com)
